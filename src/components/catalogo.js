...
export default function Catalogo () {
    return (
        ...
        <div class="tablet">
        <VStack width='100%' h='100%' columnGap={0}>
            <VStack h='100%' width='90%' fontFamily='Roboto-Regular' textAlign='center'>
              <Heading marginTop='1%' textAlign='center' letterSpacing='1px'>COMUNÍCATE CON NOSOTROS</Heading>
              <Text w='100%' color='rgb(129,129,129)' letterSpacing='0.10vw' lineHeight='29px' fontSize='20px' marginTop='1%'>Ponte en contacto con nosotros a través de Linkedin o vía Correo Electrónico</Text> 
              <Text w='100%' color='rgb(129,129,129)' letterSpacing='0.10vw' lineHeight='29px' fontSize='20px' margin='1% 0 1% 0'>Escríbenos a ventas@din-ex.com o ve todas las opciones por región en nuestra sección de Contacto</Text>
              <Text w='100%' color='rgb(129,129,129)' letterSpacing='0.10vw' lineHeight='29px' fontSize='20px'>Estamos para servirte con cualquier duda sobre nuestros productos y soluciones industriales.</Text>
            ...
            <VStack justify='center' width='98%' height='100%' textAlign='center'>
              <HStack width='100%' justify='center' marginBottom='4%'>
                <Text width='50%' fontSize='32px'>DESCARGA <br></br>EL CATÁLOGO <br/><b>2024</b></Text>
        ...
        <VStack width='100%' h='100%' columnGap={0}>
            <VStack h='100%' width='90%'>
              <Heading marginTop='1%' textAlign='center' letterSpacing='1px'>COMUNÍCATE CON NOSOTROS</Heading>
              <Text w='100%' textAlign='center' color='rgb(129,129,129)' letterSpacing='0.08vw' fontFamily='Roboto-Regular' lineHeight='29px' fontSize='17px' marginTop='1%'>Ponte en contacto con nosotros a través de Linkedin o vía Correo Electrónico</Text> 
              <Text w='100%' textAlign='center' color='rgb(129,129,129)' letterSpacing='0.08vw' fontFamily='Roboto-Regular' lineHeight='29px' fontSize='17px' margin='1% 0 1% 0'>Escríbenos a ventas@din-ex.com o ve todas las opciones por región en nuestra sección de Contacto</Text>
              <Text w='100%' textAlign='center' color='rgb(129,129,129)' letterSpacing='0.08vw' fontFamily='Roboto-Regular' lineHeight='29px' fontSize='17px'>Estamos para servirte con cualquier duda sobre nuestros productos y soluciones industriales.</Text>
              <Link href='https://api.whatsapp.com/send?phone=528128943229' isExternal><Button transitionDuration='0.3s' _hover={{transform: 'scale(1.1)' , bgColor: '#ffe500' , color: 'black'}} _active={{transform: 'scale(0.9)' , bgColor: '#b3a000'}} bgColor='#64b161' color='white' leftIcon={<AiOutlineWhatsApp />} colorScheme='greendinex' borderRadius='10vh' fontSize='13px' letterSpacing='2px' fontFamily='Roboto-Light'>Te atendemos por Whatsapp</Button></Link>
            </VStack>
            <br/>
            <VStack textAlign='center' width='98%' height='100%'>
              <HStack width='100%' marginBottom='4%'>
                <Text width='50%' letterSpacing='0.12vw' fontSize='26px'>DESCARGA <br></br>EL CATÁLOGO <br/><b>2024</b></Text>
                <Image width='50%' float='left' src={catalogoportada} alt='catalogoportada'></Image> 
              </HStack>
              <Text w='90%' textAlign='center' letterSpacing='0.06vw' fontFamily='Roboto-Regular' fontSize='19px' color='rgb(122,122,122)'>Encuentra una gran variedad de categorías de productos que cubren todo el espectro de tu operación.</Text>
              <Link href='https://drive.google.com/file/d/1_cCd4lWZC_5TjJ4u2UUpr2heDshMKl0C/view?usp=sharing' isExternal><Button transitionDuration='0.3s' _hover={{transform: 'scale(1.1)' , bgColor: 'rgb(255,184,20)' , color: 'black'}} _active={{transform: 'scale(0.9)' , bgColor: '#b3a000'}} bgColor='rgb(255,229,0)' color='Black' fontSize='13px' borderRadius='10vh' letterSpacing='2px' fontFamily='Roboto-Regular'>DESCARGAR PDF EN ESPAÑOL</Button></Link>
            </VStack>
          </VStack>
        </div>
        </ChakraProvider>
