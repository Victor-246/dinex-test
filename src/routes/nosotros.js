                        ...
                        <HStack justify='center' margin='0' p='0' position='relative' columnGap='0'>
                            ...
                            <Box h='100%' bgColor='rgba(0,0,0,0.2)' position='absolute' width='100%'>
                                <Flex w='100%' height='100%' alignItems='center' textAlign='right' justify='right'>
                                    <Box w='100%' h='min-content'><Text marginRight='12%' lineHeight='120px' color='white' fontSize='120px' fontWeight='bold' fontFamily='Montserrat-ExtraBold'><Text as='span' color='rgb(255,230,0)'>Dinex</Text><br />Soluciones<br />Industriales</Text></Box>
                                </Flex>
                            </Box>
                        </HStack>
                        <Center><Heading w='100%' bgColor='rgb(23,25,38)' color='rgb(255,230,0)' padding='2%' marginBottom='1.5%' letterSpacing='0.10vw' fontSize='3xl' fontFamily='artegra-600' textAlign='center'>MANTENEMOS TU OPERACIÓN EN CONSTANTE ACTUALIZACIÓN.</Heading></Center>
                        <br />
                        <Stack w='100%' alignItems='center'>
                            <Box w='80%' textAlign='justify' fontFamily='Roboto-Regular' letterSpacing='0.06vw' lineHeight='30px'>
                                <Text fontSize='3xl' marginTop='1%'>
                        ...
                        <HStack width='100%' justify='center'>
                            <HStack letterSpacing='0.08vw' w='92%' alignItems='start' textAlign='center' fontFamily='Roboto-Regular' >
                                <VStack w='100%'>
                                    ...
                                    <Text fontSize='3xl' marginTop='1%' fontWeight='bolder' color='black'>MISIÓN</Text>
                                    <Text lineHeight='35px' fontSize='3xl' color='rgb(100,100,100)'>Solucionar cualquier tipo de requerimiento dentro de la cadena de suministro, ofreciendo óptimas alternativas enfocadas en las necesidades de nuestros clientes.</Text>
                                </VStack>
                                <VStack w='100%'>
                                    <Image w='17%' src={vision} alt='vision'></Image>
                                    <Text fontSize='3xl' marginTop='1%' fontWeight='bolder' color='black'>VISIÓN</Text>
                                    <Text lineHeight='35px' fontSize='3xl' color='rgb(100,100,100)'>Convertirnos en un socio estratégico en la industria y mantenernos como la mejor alternativa comercial para nuestros clientes, siempre basando nuestras operaciones en la honestidad, lealtad y confiabilidad.</Text>
                                </VStack>
                            </HStack>
                        </HStack>
                        <hr />
                        <Heading textAlign='center' fontSize='3xl' fontFamily='Roboto-Regular'>VALORES AGREGADOS</Heading><br />
                        <HStack width='100%' justify='center'>
                            <HStack w='90%' alignItems='start' textAlign='center' fontFamily='Roboto-Regular' color='rgb(100,100,100)' fontSize='3xl' lineHeight='34px' letterSpacing='0.08vw'>
                                <VStack w='100%'>
